...
const u8 gOtherText_ExpShareOn[] = _("The Exp. Share was turned on.{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_ExpShareOff[] = _("The Exp. Share was turned off.{PAUSE_UNTIL_PRESS}");
